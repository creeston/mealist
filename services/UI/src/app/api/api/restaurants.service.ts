...
export class RestaurantsService {
  ...
  public getRestaurant(
    ...
    let localVarPath = `/restaurants/${this.configuration.encodeParam({
      name: 'id',
      value: id,
      in: 'path',
      style: 'simple',
  ...
  public getRestaurants(
    ...
    let localVarPath = `/restaurants`;
    return this.httpClient.request<Array<Restaurant>>(
      'get',
      `${this.configuration.basePath}${localVarPath}`,
      {
        context: localVarHttpContext,
  ...
  public updateRestaurant(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling updateRestaurant.'
      );
    }
